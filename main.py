...
if __name__ == '__main__':
    ...
    while not done:
        ...
        screen.blits(((theChat.surface,[15,15]),(theClock.surface,[15,450]),(blankFrame.surface,[230,15])))
        screen.blits(((blankCard.surface,[230,394]),(blankCard.surface,[376,394]),(blankCard.surface,[522,394]),(blankCard.surface,[668,394]),(blankCard.surface,[814,394])))
        pygame.display.flip()
    server.shutdown()
    pygame.quit()
